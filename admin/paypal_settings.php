...
<tr><td width='50%' class='table' align='left'><b><i>{$lang['paypal_array_six']}</i></b>{$lang['paypal_amount_invite']}</td><td class='table' align='left'><input type='text' name='inv_amt_6' size='4' value='" . htmlsafechars($paypal_config['inv_amt_6']) . "' /></td></tr>
