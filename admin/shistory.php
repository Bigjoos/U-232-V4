...
if (mysqli_num_rows($res) == 0) $HTMLOUT.= $lang['shistory_none'];
    ...
    while ($arr = mysqli_fetch_assoc($res)) {
        ...
        if ($arr['to_user'] == $CURUSER['id'] || ($arr['userid'] == $CURUSER['id'] && $arr['to_user'] != 0)) $private = "<img src='{$INSTALLER09['pic_base_url']}private-shout.png' alt='{$lang['shistory_private']}' title='{$lang['shistory_private2']}' width='16' style='padding-left:2px;padding-right:2px;' border='0' />";
