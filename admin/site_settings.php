...
if ($CURUSER['id'] === 1) $HTMLOUT.= "<tr><td width='50%' class='table' align='left'>{$lang['sitesettings_online']}</td><td class='table' align='left'>{$lang['sitesettings_yes']}<input class='table' type='radio' name='site_online' value='1' " . ($site_settings['site_online'] ? 'checked=\'checked\'' : '') . " />{$lang['sitesettings_no']}<input class='table' type='radio' name='site_online' value='0' " . (!$site_settings['site_online'] ? 'checked=\'checked\'' : '') . " /></td></tr>";
...
<tr><td width='50%' class='table' align='left'>{$lang['sitesettings_bpdload']}</td><td class='table' align='left'><input type='text' name='bonus_per_dload' size='3' value='" . htmlsafechars($site_settings['bonus_per_download']) . "' /></td></tr>
