...
if ($action == 'add') {
    ...
    if ($INSTALLER09['BBcode'] && function_exists('BBcode')) $HTMLOUT.= BBcode($body, FALSE);
    ...
    if ($INSTALLER09['BBcode'] && function_exists('BBcode')) $HTMLOUT.= BBcode(htmlsafechars($arr["text"]) , FALSE);
