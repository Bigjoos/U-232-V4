...
if ($game) {
    ...
    if ($_POST["game"] == 'hit') {
        if ($start_ == 'yes') {
            ...
            elseif ($arr['status'] == 'playing')
                stderr($lang['bj_sorry'], "{$lang['bj_you_most_finish_current']}<form method='post' action='" . $_SERVER['PHP_SELF'] . "'><input type='hidden' name='game' value='hit' readonly='readonly' /><input type='hidden' name='continue' value='yes' readonly='readonly' /><input type='submit' value='{$lang['bj_continue_old_game']}' /></form>");
            ...
            if ($points < 21) {
                ...
                <form method='post' action='" . $_SERVER['PHP_SELF'] . "'><input type='hidden' name='game' value='stop' readonly='readonly' /><input type='submit' value='{$lang['bj_stay']}' /></form>
                </td></tr>";
                }
        ...
        if ($points == 21) {
            ...
            <tr><td align='center'><b>{$lang['bj_points']} = {$points}</b></td></tr>";
            $HTMLOUT .= "<tr>
      <td align='center'><form method='post' action='" . $_SERVER['PHP_SELF'] . "'><input type='hidden' name='game' value='hit' readonly='readonly' /><input type='submit' value='{$lang['bj_hitme']}' /></form></td>
      </tr>";
            $HTMLOUT .= "<tr>
      <td align='center'><form method='post' action='" . $_SERVER['PHP_SELF'] . "'><input type='hidden' name='game' value='stop' readonly='readonly' /><input type='submit' value='{$lang['bj_stay']}' /></form></td>
      </tr>";
            $HTMLOUT .= "</table></td></tr></table><br />";
            echo stdhead($lang['bj_title']) . $HTMLOUT . stdfoot();
        }
    ...
    $HTMLOUT .= "<h1>{$INSTALLER09['site_name']} {$lang['bj_title']}</h1>
